...
In preparation for all these data releases I've been firing up the viz terminal and getting my statistical software all stretched out.  Good news is, there are all kinds of great innovations coming out to help me. Bad news is there's so much to keep up with.  In this post I'm going to try out some new techniques and work on some fundamentals. 
...
```{r ,fig-tidy-1, warning=FALSE, eval=F,cache=TRUE,echo=TRUE, message=FALSE,fig.height=5,fig.width=6.5 }
...
```{r ,fig-tidy-2, warning=FALSE, cache=TRUE,echo=TRUE, message=FALSE,fig.height=5,fig.width=6.5 }
...
```{r ,fig-tidy-3, warning=FALSE, cache=TRUE,echo=TRUE, eval=F,message=FALSE,fig.height=5,fig.width=6.5 }
...
#add the "US" at the top and the bottom of the list of states 
...
```{r ,fig-tidy-4, warning=FALSE, cache=TRUE,echo=TRUE, eval=F,message=FALSE,fig.height=5,fig.width=6.5 }
