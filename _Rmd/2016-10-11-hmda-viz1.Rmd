...
```{r ,fig-mysetup-1, warning=FALSE, eval=F,cache=TRUE,echo=F, message=FALSE,fig.height=5,fig.width=7 }
library('ggbeeswarm')
library(viridis)
library(data.table)
library(ggplot2)
...
source('C:/Users/Leonard/Documents/Data Viz/blog/multiplot.R')

setwd('C:/Users/Leonard/Documents/Data Viz/blog/hmda')
mydata <- fread("~/Data Viz/blog/hmda/hmda_lar.csv")
m0<-copy(mydata)
...
ggplot() +
  ...
  labs(title="Median loan amount by county in 2015",
...
```{r ,fig-hmda-2015-viz1, warning=FALSE, eval=T,cache=TRUE,echo=F, message=FALSE,fig.height=7,fig.width=10 }
setwd('C:/Users/Leonard/Documents/Data Viz/blog/hmda')
...
```{r ,fig-hmda-2015-viz2, warning=FALSE, eval=T,cache=TRUE,echo=F, message=FALSE,fig.height=6,fig.width=9 }
...
```{r ,fig-hmda-2015-viz3, warning=FALSE, eval=T,cache=TRUE,echo=F, message=FALSE,fig.height=7,fig.width=10 }
...
```{r ,fig-hmda-2015-code1, warning=FALSE, eval=F,cache=TRUE,echo=T, message=FALSE,fig.height=7,fig.width=10 }
