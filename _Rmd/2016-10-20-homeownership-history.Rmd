...
```{r ,fig-mysetup-1, warning=FALSE, eval=T,cache=TRUE,echo=T, message=FALSE,fig.height=5,fig.width=7 }
library(viridis)
library(data.table)
library(ggplot2)
library(scales)
...
```{r ,fig-horate-1, warning=FALSE, eval=T,cache=TRUE,echo=T, message=FALSE,fig.height=4,fig.width=7.5 }
...
```{r ,fig-horate-2, warning=FALSE, eval=T,cache=TRUE,echo=T, message=FALSE,fig.height=10,fig.width=8 }
...
```{r ,fig-horate-3, warning=FALSE, eval=T,cache=TRUE,echo=T, message=FALSE,fig.height=8,fig.width=7 }
...
```{r ,fig-horate-4, warning=FALSE, eval=F,cache=TRUE,echo=T, message=FALSE,fig.height=8,fig.width=7 }
