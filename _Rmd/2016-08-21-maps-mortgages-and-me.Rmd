...
```{r ,fig-mysetup-1, warning=FALSE, eval=F,cache=TRUE,echo=TRUE, message=FALSE,fig.height=5,fig.width=7 }
#load libraries
library('ggbeeswarm')
library(data.table)
library(ggplot2)
...
```{r ,fig-map-1, warning=FALSE, eval=T,cache=TRUE,echo=TRUE, message=FALSE,fig.height=5,fig.width=6.5 }
...
```{r ,fig-map-2, warning=FALSE, eval=T,cache=TRUE,echo=TRUE, message=FALSE,fig.height=5,fig.width=7 }
...
```{r ,fig-map-3, warning=FALSE, eval=T,cache=TRUE,echo=TRUE, message=FALSE,fig.height=7,fig.width=10 }
...
```{r ,fig-map-4, warning=FALSE, eval=F,cache=TRUE,echo=TRUE, message=FALSE,fig.height=7,fig.width=10 }
...
```{r ,fig-map-5, warning=FALSE, eval=F,cache=TRUE,echo=TRUE, message=FALSE,fig.height=7,fig.width=10 }
...
```{r ,fig-map-6, warning=FALSE, eval=F,cache=TRUE,echo=TRUE, message=FALSE,fig.height=7,fig.width=10 }
popDF<-data.table(popDF)
