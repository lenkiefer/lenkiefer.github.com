...
```{r ,fig-chartbk-1-aug-2016, warning=FALSE,eval=T,cache=TRUE,echo=F, message=FALSE,fig.height=6,fig.width=7.5 }
i<-max(mdata[year==2016]$week)
pmms1<-
    ...
    geom_text(data=mdata[date>='2015-12-31' & week==i],nudge_y=-.070,hjust=0,size=3)+
  ...
  theme(plot.subtitle=element_text(size=10))+
    ...
    theme(plot.caption=element_text(hjust=0,vjust=1,size=8,margin=margin(t=10)))+
...
pmms2<-  
  ...
  theme(legend.position="none")+
  geom_vline(xintercept=i,linetype=2,color=viridis(10)[2])+
  ...
  labs(x="Week of year", y="Mortgage Rate (%)",
       ...
       caption="Dotted line compares rates in 34th week of year")+
  theme(plot.title=element_text(size=12))+
  theme(plot.subtitle=element_text(size=10))+
    theme(axis.title=element_text(size=8))+
      theme(axis.text=element_text(size=8))+
...
multiplot(pmms1,pmms2,cols=1)     
```

```{r ,fig-chartbk-2-aug-2016, include=T,warning=FALSE,eval=T,cache=TRUE,echo=F, message=FALSE,fig.height=4,fig.width=4 }
...
```{r ,fig-chartbk-3-aug-2016,asis=F, warning=FALSE,eval=T,cache=TRUE,echo=F, message=FALSE,fig.height=5,fig.width=7.5 }  
     ## GDP charts 
...
```{r ,fig-chartbk-sales-aug-2016,asis=F, warning=FALSE,eval=T,cache=TRUE,echo=F, message=FALSE,fig.height=5,fig.width=7.5 }  
...
```{r ,fig-chartbk-starts-aug-2016,asis=F, warning=FALSE,eval=T,cache=TRUE,echo=F, message=FALSE,fig.height=5,fig.width=7.5 }  
...
```{r ,fig-chartbk-fhfa-viz-aug-2016,asis=F, warning=FALSE,eval=T,cache=TRUE,echo=F, message=FALSE,fig.height=7,fig.width=7.5 }  
...
map1<-
  ...
  graph1<-
    ...
    labs(x="House Price Index\nlog scale,Q1:2001=100",y="",title=paste0("House Price Index Q",qq,":",yy),
         caption="dot is value, line trailing 4-quarter min/max")+
    theme(plot.caption=element_text(hjust=0,vjust=1,margin=margin(t=10)))
...
```{r ,fig-chartbk-code-aug-2016,asis=F, warning=FALSE,eval=F,cache=TRUE,echo=T, message=FALSE,fig.height=5,fig.width=7.5 }  
