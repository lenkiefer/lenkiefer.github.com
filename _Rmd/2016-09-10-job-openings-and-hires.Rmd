...
```{r ,fig-JOLTS-setup1, warning=FALSE, eval=T,cache=TRUE,echo=F, message=FALSE,fig.height=5,fig.width=8 }
...
```{r ,fig-JOLTS-graph1, warning=FALSE, eval=T,cache=TRUE,echo=F, message=FALSE,fig.height=5,fig.width=7.5 }
...
```{r ,fig-JOLTS-graph2, warning=FALSE, eval=T,cache=TRUE,echo=F, message=FALSE,fig.height=5.5,fig.width=8.5 }
...
```{r ,fig-JOLTS-graph2b, warning=FALSE, eval=T,cache=TRUE,echo=F, message=FALSE,fig.height=5.5,fig.width=8.5 }
...
```{r ,fig-JOLTS-graph3, warning=FALSE, eval=T,cache=TRUE,echo=F, message=FALSE,fig.height=5,fig.width=8 }
...
```{r ,fig-JOLTS-code1, warning=FALSE, eval=F,cache=TRUE,echo=T, message=FALSE,fig.height=5,fig.width=8 }
...
```{r ,fig-JOLTS-code2, warning=FALSE, eval=F,cache=TRUE,echo=T, message=FALSE,fig.height=5,fig.width=8 }
...
```{r ,fig-JOLTS-code3, warning=FALSE, eval=F,cache=TRUE,echo=T, message=FALSE,fig.height=5,fig.width=8 }
...
```{r ,fig-JOLTS-code-bv, warning=FALSE, eval=F }
...
```{r ,fig-JOLTS-code4, warning=FALSE, eval=F,cache=TRUE,echo=T, message=FALSE,fig.height=5,fig.width=8 }
