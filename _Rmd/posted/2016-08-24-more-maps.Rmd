...
```{r ,fig-mymap-1, warning=FALSE, eval=T,cache=TRUE,echo=TRUE, message=FALSE,fig.height=7,fig.width=7 }
#load some libraries
library(data.table)
library(reshape2)
library(stringr)
...
```{r ,fig-mygraph-1, warning=FALSE, eval=T,cache=TRUE,echo=TRUE, message=FALSE,fig.height=7,fig.width=8 }
