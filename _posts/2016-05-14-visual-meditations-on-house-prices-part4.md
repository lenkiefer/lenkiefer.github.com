...
This plot shows the distribution of house price appreciation (month-over-month percent change) across each metro area compared to the U.S. index. Values that are appreciating (depreciating) are colored blue (red) and the orange line corresponds to the U.S. index for that month. I've written up instructions on how to make such a plot [in an earlier post]({% post_url 2016-04-06-dot-plots-and-distributions%}).
