...
LAST WEEK I [SHOWED YOU](../../../../2016/12/08/10-ways-to-visualize-rates ) 10 TASTY WAYS TO VISUALIZE MORTGAGE RATES, but I've got another delicious one for you. Y'all like ribbon candy?

As before we'll create this chart with [R](https://www.r-project.org/). 

## The data

The data I'm going to use are estimates of weekly U.S. average 30-year fixed mortgage rates from the [Primary Mortgage Market Survey](http://www.freddiemac.com/pmms/index.html). See my [earlier post](../../../../2016/12/08/10-ways-to-visualize-rates ) for some additional information on the data we'll use.
