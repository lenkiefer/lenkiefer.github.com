...
As I have been on a kick making R flexdashboards (see [this](../../../../../../2017/01/08/mortgage-rate-viewer ), [this](../../../../../../2017/01/14/year-in-review-remix ), [this](../../../../../../2017/01/16/cross-talk-dashboard ) and [this](../../../../../../2017/01/20/flexin-friday ) for examples and [this post for a guide on building a flexdashboard](../../../../../../2017/01/22/build-flex )). I figured it would be fun to convert this viz into a flexdashboard.
...
Like in my [guide on building a flexdashboard](../../../../2017/01/22/build-flex ) we are going to use [crosstalk](https://github.com/rstudio/crosstalk) to get the graphs to respond to a filter select box.  And like before, we'll use [plotly](https://plot.ly/r/) to make the graphs.  We'll also use [DT](https://rstudio.github.io/DT/) to add an interactive data table.
...
You can see a fullscreen version [here](../../../../chartbooks/jan2017/migration_flex2.html). 

You can get the code by clicking on the source button on the top right.

<iframe src="../../../../chartbooks/jan2017/migration_flex2.html" height="800" width="1200"></iframe>
