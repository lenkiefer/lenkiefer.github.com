...
RECENTLY I [HAVE BEEN](../../../../2017/01/22/build-flex ) EXPLORING [FLEXDASHBOARDS](http://rmarkdown.rstudio.com/flexdashboard/index.html) to visualize data.  In this post I want to focus on a tool I've found particularly useful, [plotly]( https://plot.ly/r/).
...
I'm going to include the code and discussion for several graphs I've been using.  I will use updated data that we used in our [Cross talk dashboard](../../../../2017/01/16/cross-talk-dashboard ). These data cover weekly mortgage rates and house prices.

### The data

We've used these data before, but if you want to follow along they are:

* Mortgage rate data [rates.xlsx spreadsheet](../../../../chartbooks/jan2017/rates.xlsx)
* Metro hpi files [hpimetro.csv](../../../../chartbooks/jan2017/data/hpimetro.csv)
* State house price file [hpistate.csv](../../../../chartbooks/jan2017/data/hpistate.csv)
...
I've made many mortgage rates plots (see [here for 10 visualizations](../../../../2016/12/08/10-ways-to-visualize-rates ) and 
[here for a flexdashboard](../../../../2017/01/08/mortgage-rate-viewer )).
...
The graph above is a static screenshot, but you can see the interactive version by [clicking here](../../../../chartbooks/jan2017/plotly/rates-jan29-2017-1.html).
...
Once again, the graph above is a static screenshot, but you can see the interactive version by [clicking here](../../../../chartbooks/jan2017/plotly/rates-jan29-2017-2.html).
...
Once again, the graph above is a static screenshot, but you can see the interactive version by [clicking here](../../../../chartbooks/jan2017/plotly/hpa-jan29-2017-1.html).
...
Once again, the graph above is a static screenshot, but you can see the interactive version by [clicking here](../../../../chartbooks/jan2017/plotly/hpa-jan29-2017-2.html).
