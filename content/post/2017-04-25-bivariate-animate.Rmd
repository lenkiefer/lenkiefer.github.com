...
tags: ["R","dataviz","maps","animation"]
categories: "dataviz"
slug: "bivariate-animate"

---

IN THIS POST I WANT TO EXTEND ON [yesterday's](../../../../2017/04/24/bivariate-map ) post and build an animated bivariate choropleth.
...
* House Price Index Data in a *.txt* file:  [fmhpi2016q4.txt](../../../../img/charts_apr_25_2017/fmhpi2016q4.txt)
* Regional lookup table in a *.txt* file:   [region.txt](../../../../img/charts_apr_25_2017/region.txt)
...
For smooth animations we'll use [tweenr](https://cran.r-project.org/web/packages/tweenr/index.html). For a simple introduction to tweenr see [this post](../../../../2016/12/19/more-tweenr-housing ).

Also see my earlier [post about tweenr](../../../../2016/05/29/improving-R-animated-gifs-with-tweenr ) for an introduction to tweenr, and more examples [here](../../../../2016/05/30/more-tweenr-animations ) and [here](../../../../2016/06/26/week-in-review ). 
...
<img src="../../../../img/charts_apr_25_2017/bivariate2.gif" >
