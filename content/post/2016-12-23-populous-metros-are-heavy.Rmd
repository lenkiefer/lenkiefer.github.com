...
``` {r, animation-1-dec23-2016,cache=FALSE,eval=T,echo=T,message=FALSE,warnings=FALSE,fig.height=3,fig.width=4 }
library(tidyverse)
library(maps)
...
``` {r, animation-3-dec23-2016,cache=FALSE,eval=F,echo=T,message=FALSE,warnings=FALSE }
...
We'll use tweenr to create the animation. See this [post about tweenr](../../../../2016/05/29/improving-R-animated-gifs-with-tweenr ) for an introduction to tweenr, and more examples [here](../../../../2016/05/30/more-tweenr-animations ) and [here](../../../../2016/06/26/week-in-review ). 

I've also added a stripped down [example that uses pre-packaged data](../../../../2016/12/19/more-tweenr-housing ) that should be even easier to follow along with.


``` {r, animation-2-dec23-2016,cache=FALSE,eval=F,echo=T,message=FALSE,warnings=FALSE }
