...
Let's try it out using the same house price data we [visualized recently](../../../../2017/05/18/state-hpa ). Details about the data are in that post, but we'll be using the [Freddie Mac House Price Index](http://www.freddiemac.com/finance/house_price_index.html) to once again visualize state house price trends.

Let's get to it.

# Data

We'll start this post with our data in hand. Just follow along [here](../../../../2017/05/18/state-hpa ) to get the data.  We'll begin with a data frame called `df.state` that looks like so.
...
library(htmlTable,quietly=T,warn.conflicts=F)    
...
<img src="../../../../img/charts_may_22_2017/geo facet hpa 05 22 2017.gif" >
