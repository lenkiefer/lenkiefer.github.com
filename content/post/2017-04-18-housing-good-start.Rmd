...
category: "economics"
tags: ["housing","dataviz"]
slug: "housing-good-start"
---

IN 2016 HOUSING IN THE UNITED STATES HAD ITS BEST YEAR IN A DECADE ([see my review](../../../../chartbooks/dec2016/index.html) or my [flexdashboard remix](../../../../2017/01/14/year-in-review-remix)) and so far 2017 has gotten off to a good **start**.  Let's take a look at [residential construction](https://www.census.gov/construction/nrc/index.html), particularly housing starts and see how they stack up to prior years.
...
We'll also try out our [modfied dark theme](../../../../2017/04/14/after-dark).
...
```{r 04-18-2017-setup-1,message=F,warning=F}
##################################################################################
...
All right, that looks pretty good, but it's after dark in my timezone, so let's apply our [dark theme](../../../../2017/04/14/after-dark) (defined in the code) to the chart.
...
We can also do our [usual business](../../../../2016/12/19/more-tweenr-housing) and animate this plot.

```{r 04-18-2017-tweenr, eval=F}
