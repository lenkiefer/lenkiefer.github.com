...
df<-rename(df,cbsa=X__1)
df<-rename(df,metro=X__2)
df<-rename(df,Value=X__4)
...
dt$cbsa<-as.integer(dt$cbsa) #coerce types for merge
...
<img src="../../../../img/charts_feb_9_2017/nar2016q4.gif">

Creating this plot took a little bit of data wrangling.  I started to write it up, but am running out of gas today.  Perhaps I'll write the data wrangling and plot creation later.  Basically I am extending the code from [this post: *populous metros are heavy!*](../../../../2016/12/23/populous-metros-are-heavy ).
