...
We're going to be visualizing the [Freddie Mac House Price Index](http://www.freddiemac.com/finance/house_price_index.html). We talked about these data earlier this month, see [this post](../../../../2017/05/02/house-price-viz ) for some other visualizations.
...
Now with the data ready, let's make a plot. First let's remix a visualization we've made [back in January](../../../../2017/01/18/workin-workout ).  In that visualization we compare U.S. unemployment to state unemployment.  Now let's do it for state house prices.  First, take a look:
...
<img src="../../../../img/charts_may_18_2017/state ribbon hpa tween 05 18 2017.gif" >
