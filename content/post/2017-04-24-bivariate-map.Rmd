...
Or you could do [like me](../../../../2017/04/23/horizon ). Just jump in we'll and figure it out as we go.  Here goes!
...
This was of course, before I [wised up](../../../../2017/04/20/global-hpi-readxl ) about [readxl](http://readxl.tidyverse.org/index.html).  But since I had these data around, we'll just start here. 
...
In the past I compared [employment and house prices](../../../../2017/02/01/emp-trends ) and a bivariate choropleth might be a good option for comparing how these variables evolve.  I've also go some research going looking at some other aspects of the housing market where such a plot might at least be useful at the data exploration stage.  
